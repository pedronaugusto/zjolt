...
Working today: every Jolt subsystem, across **1429 C entry points** — shapes,
...
|  | joltc | zjolt |
|---|---|---|
| entry points returning an error code | none | 757 |
...
Every Jolt subsystem is bound: **1429 C entry points** across **25 headers**,
