...
Working today: every Jolt subsystem, across **1440 C entry points** — shapes,
...
|  | joltc | zjolt |
|---|---|---|
| entry points returning an error code | none | 767 |
...
Every Jolt subsystem is bound: **1440 C entry points** across **25 headers**,
