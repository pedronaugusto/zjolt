...
Working today: every Jolt subsystem, across **1446 C entry points** — shapes,
...
|  | joltc | zjolt |
|---|---|---|
| entry points returning an error code | none | 773 |
...
Every Jolt subsystem is bound: **1446 C entry points** across **25 headers**,
